...
function draw() {
  ...
  var collution=Matter.SAT.collides(boggie6.body,rock1.body)

  if(collution.collided){
    flag=1
  }
  ...
  function keyPressed(){
    if(keycode===right_Arrow){
      Matter.Body.applyForce(boggie6.body,{x:boggie6.body.position.x,y:boggie6.body.position.y},{x:0.5,y:10})
      trainSound.play();
    }
  }
